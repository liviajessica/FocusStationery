...
import id.ac.umn.focus_server.Model.User;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                singInUser(edtPhone.getText().toString(),edtPassword.getText().toString());
            }
        });
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(localPhone).exists())
                {
                    ...
                    if(Boolean.parseBoolean(user.getIsStaff())) //if isStaff == true
                    {
                        ...
                        Toast.makeText(LoginActivity.this, "Please with Staff account", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    mDialog.dismiss();
